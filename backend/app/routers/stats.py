...
def stats(db:Session=Depends(get_db)):
 ...
 return {"total":total,"pending":counts.get("pending",0),"annotated":counts.get("annotated",0),"approved":counts.get("approved",0),"rejected":counts.get("rejected",0),"needs_review":counts.get("needs_review",0),"styles":styles}
