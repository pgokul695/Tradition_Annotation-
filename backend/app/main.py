...
from .routers import images, annotate, export, stats
...
app.include_router(images.router); app.include_router(annotate.router); app.include_router(export.router); app.include_router(stats.router)
@app.post("/api/ingest")
